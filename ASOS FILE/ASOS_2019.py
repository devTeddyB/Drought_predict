...
cur = conn.cursor()
cur.execute("DROP TABLE IF EXISTS ASOS_2019;")

# cur.execute("""CREATE TABLE ASOS_2019(
#                                     일시 DATE,
#                                     지점 VARCHAR(32),
#                                     평균기온(°C) REAL,
#                                     평균수증기압(hPa) REAL,
...
query = ("INSERT INTO ASOS_2019 (tm, stnNm, avgTa, avgPv, avgRhm, sumGsr, avgWs, sumRn) VALUES (?, ?, ?, ?, ?, ?, ?, ?)")


# query = ("INSERT INTO ASOS_2019 (일시, 지점, 평균기온(°C), 평균수증기압(hPa), 평균상대습도(%), 합계일사량(MJ/m2), 평균풍속(m/s), 월합강수량(mm)) VALUES (?, ?, ?, ?, ?, ?, ?, ?)")
...
date_data = {'2019-01':'2019-01-31', '2019-02':'2019-02-28', '2019-03':'2019-03-31', '2019-04':'2019-04-30', '2019-05':'2019-05-31', '2019-06':'2019-06-30',
            '2019-07':'2019-07-31', '2019-08':'2019-08-31', '2019-09':'2019-09-30', '2019-10':'2019-10-31', '2019-11':'2019-11-30', '2019-12':'2019-12-31'}


# print(len(stnNm))
df = pd.DataFrame()
for j in stnIds:
    df_load = pd.read_csv('C:/Users/eorhk/Desktop/Section3/Project/data/월자료/2019/SURFACE_ASOS_' + f'{j}' + '_MNH_2019_2019_2020.csv', encoding='cp949', sep=',')
    # print(df_load)
