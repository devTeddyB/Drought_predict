...
cur = conn.cursor()
cur.execute("DROP TABLE IF EXISTS ASOS_2020;")

cur.execute("""CREATE TABLE ASOS_2020 (
                tm DATE,
                stnNm VARCHAR(32),
                avgTa REAL,
                avgPv REAL,
...
query = ("INSERT INTO ASOS_2020 (tm, stnNm, avgTa, avgPv, avgRhm, sumGsr, avgWs, sumRn) VALUES (?, ?, ?, ?, ?, ?, ?, ?)")
...
date_data = {'2020-01':'2020-01-31', '2020-02':'2020-02-29', '2020-03':'2020-03-31', '2020-04':'2020-04-30', '2020-05':'2020-05-31', '2020-06':'2020-06-30',
            '2020-07':'2020-07-31', '2020-08':'2020-08-31', '2020-09':'2020-09-30', '2020-10':'2020-10-31', '2020-11':'2020-11-30', '2020-12':'2020-12-31'}

# 202~130 까지 수정

df = pd.DataFrame()
for j in stnIds:
    df_load = pd.read_csv('C:/Users/eorhk/Desktop/Section3/Project/data/월자료/2020/SURFACE_ASOS_' + f'{j}' + '_MNH_2020_2020_2021.csv', encoding='cp949', sep=',')
    # print(df_load)
